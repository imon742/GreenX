...
- Bangladesh industrial rooftop solar — Unsplash image URL used for the hero/solar capability.
- Industrial standby generator — Unsplash image used for generator capability.
- Modern elevator/lobby — Unsplash image used for lift capability.
- Electrical control panel — Unsplash image used for electrical/protection capability.
