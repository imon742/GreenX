...
export default function FloatingContact({ settings }: { settings: SiteSettings }) {
  ...
  return <>
    {wa && <a className="floating-whatsapp" target="_blank" rel="noreferrer" href={`https://wa.me/${wa}`} aria-label="Chat with Green X on WhatsApp"><Icon name="whatsapp"/><span>WhatsApp</span></a>}
