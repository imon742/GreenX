...
export default async function ProductPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <>
    ...
    <section className="section-v3 section-soft-v3"><div className="container simple-cta-v3"><div><span className="kicker">Need sizing or selection?</span><h2>Tell us the application, load and expected runtime.</h2><p>Greenex can help narrow the correct capacity and integration approach before quotation.</p></div><Link className="btn btn-primary" href="/contact#quote">Ask for Technical Guidance <Icon name="arrow"/></Link></div></section>
  </>;
}
