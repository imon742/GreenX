...
export const metadata={title:'Contact',description:'Contact Green X Power Engineering for solar, generator, lift, electrical and maintenance project enquiries in Bangladesh.'};
