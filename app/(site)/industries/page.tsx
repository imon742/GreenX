...
export const metadata={title:'Industries',description:'Greenex engineering solutions for industrial, commercial, residential and infrastructure projects in Bangladesh.'};
...
export default function Industries(){return <>
  ...
  <section className="gx-section gx-cta-section"><div className="container gx-final-cta"><div><span className="kicker">Your facility</span><h2>Need a solution designed around your operating requirement?</h2><p>Start with an indicative system estimate or speak directly with the Greenex engineering team.</p></div><div><Link className="gx-primary-cta" href="/estimate-system-size">Estimate System Size <Icon name="arrow"/></Link><Link className="gx-secondary-cta" href="/contact">Contact Greenex</Link></div></div></section>
</>}
